...
<nav class="hk-breadcrumb" aria-label="breadcrumb">
    <ol class="breadcrumb breadcrumb-light bg-transparent">
        ...
        <li class="breadcrumb-item active" aria-current="page">รายละเอียดผู้แทนขาย</li>
    </ol>
</nav>
<!-- /Breadcrumb -->
...
<div class="container-fluid px-xxl-65 px-xl-20">
    ...
    <div class="hk-pg-header mb-10">
        <div>
            <h4 class="hk-pg-title"><span class="pg-title-icon"><i class="ion ion-md-people"></i></span>ข้อมูล ผู้แทนขาย</h4>
        </div>
        <div class="d-flex">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <p class="detail_listcus mt-10" style="font-size: 16px;"><span>ชื่อ</span> : {{ $value['name'] }}</p>
                                ...
                                <p class="detail_listcus mt-10" style="font-size: 16px;">{{ $value['area_info'] }}</p>
                                <p class="detail_listcus mt-10" style="font-size: 16px;"><span>สังกัด</span> : {{ $value['team_info'] }}</p>
                            </div>
                        </div>
                        @endforeach
                    </div>
