         ...
         <div class="hk-pg-header mb-10">
            ...
            <div class="content-right d-flex">
                @if (Auth::user()->status == 1)
                    <a href="{{url('product_new')}}" type="button" class="btn btn-secondary btn-rounded ml-2"> ย้อนกลับ</a>
                @elseif (Auth::user()->status == 2)
                    <a href="{{url('lead/product_new')}}" type="button" class="btn btn-secondary btn-rounded ml-2"> ย้อนกลับ</a>
                    @elseif (Auth::user()->status == 3)
                    <a href="{{url('head/product_new')}}" type="button" class="btn btn-secondary btn-rounded ml-2"> ย้อนกลับ</a>
                @endif
