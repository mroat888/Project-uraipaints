                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="button-list">
                                                            @if ($value->status_pin == 1)
                                                            <a href="{{url('lead/status_pin_update', $value->id)}}" class="btn btn-icon btn-secondary mr-10">
                                                                <span class="btn-icon-wrap"><i
                                                                        data-feather="feather"></i></span></a>
                                                            @else
                                                            <a href="{{url('lead/status_pin_update', $value->id)}}" class="btn btn-icon btn-primary mr-10">
                                                                <span class="btn-icon-wrap"><i
                                                                        data-feather="feather"></i></span></a>
                                                            @endif
                                                            ...
                                                            <a href="{{url('lead/delete_note', $value->id)}}" class="btn btn-icon btn-danger mr-10" onclick="return confirm('ต้องการลบข้อมูลนี้ใช่หรือไม่ ?')">
    ...
    <div class="modal fade" id="exampleModalLarge01" tabindex="-1" role="dialog" aria-labelledby="exampleModalLarge01"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="{{ url('lead/create_note') }}" method="post" enctype="multipart/form-data">
                    @csrf
    ...
    <div class="modal fade" id="editNote" tabindex="-1" role="dialog" aria-labelledby="editNote" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="{{ url('lead/update_note') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6 form-group">
