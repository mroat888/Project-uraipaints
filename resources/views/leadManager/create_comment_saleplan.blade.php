        ...
        <div class="row">
            <div class="col-xl-12">
                <section class="hk-sec-wrapper">
                    <div class="row">
                        <div class="col-sm">
                            <form action="{{ url('lead/create_comment_saleplan') }}" method="post" enctype="multipart/form-data">
                                @csrf
                            <div class="modal-body">
                                <div>
                                    <h5>ความคิดเห็น</h5>
                                </div>
                                <input type="hidden" name="id" value="{{$data->assign_id}}">
                                    <div class="card-body">
                                        <textarea class="form-control" name="comment" cols="30" rows="5" placeholder="เพิ่มความคิดเห็น" value=""
                                        type="text">{{$data->assign_comment_detail}}</textarea>
                                    </div>
                            </div>
