...
@section('content')
 ...
 <nav class="hk-breadcrumb" aria-label="breadcrumb">
    <ol class="breadcrumb breadcrumb-light bg-transparent">
        <li class="breadcrumb-item active">ป้ายกำกับ (ข่าวสาร)</li>
    </ol>
</nav>
<!-- /Breadcrumb -->
    ...
    <div class="container-fluid px-xxl-65 px-xl-20">
        ...
        <div class="hk-pg-header mb-10">
            <div>
                <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i
                    data-feather="bookmark"></i></span></span>ป้ายกำกับ (ข่าวสาร)</h4>
            </div>
            <div class="d-flex">
        ...
        <!-- /Title -->
            ...
            <section class="hk-sec-wrapper">
                <h5 class="hk-sec-title">รายการป้ายกำกับ (ข่าวสาร)</h5>
                <div class="row">
                    <div class="col-sm">
                                    ...
                                    <tr align="center">
                                        ...
                                        <td style="width: 10px;">
                                                    <button onclick="edit_modal({{ $value->id }})"
                                                        class="btn btn-icon btn-warning" data-toggle="modal" data-target="#editMasterTag">
                                                        <span class="btn-icon-wrap"><i data-feather="edit"></i></span></button>
                                        </td>
                                        <td align="left">
                                            <form action="{{url('admin/delete_master_news_tag', $value->id)}}" method="get">
                                                @csrf
    ...
    <!-- /Container -->
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">ฟอร์มบันทึกป้ายกำกับ (ข่าวสาร)</h5>
     ...
     <div class="modal fade" id="editMasterTag" tabindex="-1" role="dialog" aria-labelledby="editMasterTag" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">ฟอร์มแก้ไขป้ายกำกับ (ข่าวสาร)</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <script>
        $("#form_insert_master_tag").on("submit", function (e) {
            ...
            $.ajax({
                type:'POST',
                url: '{{ url("admin/create_master_news_tag") }}',
                data:formData,
                cache:false,
                contentType: false,
                processData: false,
    ...
    <script>
        ...
        function edit_modal(id) {
            $.ajax({
                type: "GET",
                url: "{!! url('admin/edit_master_news_tag/"+id+"') !!}",
                dataType: "JSON",
                async: false,
...
<script>
    $("#form_update_master_tag").on("submit", function (e) {
        ...
        $.ajax({
            type:'POST',
            url: '{{ url("admin/update_master_news_tag") }}',
            data:formData,
            cache:false,
            contentType: false,
            processData: false,
