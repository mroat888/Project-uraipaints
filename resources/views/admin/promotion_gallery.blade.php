...
@section('content')
 ...
 <nav class="hk-breadcrumb" aria-label="breadcrumb">
    <ol class="breadcrumb breadcrumb-light bg-transparent">
        ...
        <li class="breadcrumb-item active">แกลลอรี่โปรโมชั่น</li>
    </ol>
</nav>
<!-- /Breadcrumb -->
    ...
    <div class="container-fluid px-xxl-65 px-xl-20">
         ...
         <div class="hk-pg-header mb-10">
            <div class="topichead-bgred"><i data-feather="image"></i> แกลลอรี่โปรโมชั่น</div>
                        ...
                        <div class="table-wrap">
                            <div class="table-responsive table-color col-md-12">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{$key + 1}}</td>
                                        <td><img src="{{ isset($value->image) ? asset('public/upload/PromotionGallery/' . $value->image) : '' }}" width="100"></td>
                                        <td>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">เพิ่มประกาศ (โปรโมชั่น)</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form id="form_insert_promotion_gallery" enctype="multipart/form-data">
                {{-- <form action="{{ url('admin/create_news_gallery') }}" method="post" enctype="multipart/form-data"> --}}
                    @csrf
                    <input type="hidden" name="promotion_id" value="{{$promotionID->id}}">
                <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <label for="firstName">รูปภาพ</label>
                                <input type="file" name="promotion_gallery[]" multiple class="form-control" required>
                            </div>
    ...
    <div class="modal fade" id="editNews" tabindex="-1" role="dialog" aria-labelledby="editNews" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="{{ url('admin/update_promotion_gallery') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <label for="firstName">รูปภาพ</label>
                                <input type="file" name="promotion_gallery" id="get_image" class="form-control" required>
                            </div>
    ...
    $("#from_promotion_delete").on("submit", function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ url('admin/delete_promotion_gallery') }}',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
        ...
        $("#form_insert_promotion_gallery").on("submit", function (e) {
            e.preventDefault();
            var formData = new FormData(this);
            $.ajax({
                type:'POST',
                url: '{{ url("admin/create_promotion_gallery") }}',
                data:formData,
                cache:false,
                contentType: false,
                processData: false,
    ...
    <script>
        ...
        function edit_modal(id) {
            $.ajax({
                type: "GET",
                url: "{!! url('admin/edit_promotion_gallery/"+id+"') !!}",
                dataType: "JSON",
                async: false,
                ...
                let img_name = '{{ asset("/public/upload/PromotionGallery") }}/' + data.dataEdit.image;
