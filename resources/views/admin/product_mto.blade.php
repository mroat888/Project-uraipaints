...
<!-- /Breadcrumb -->
                            ...
                            <div class="table-responsive col-md-12 table-color">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$date}}</td>
                                        <td>
                                            <a href="#" onclick="view_modal({{ $value->id }})" data-toggle="modal" data-target="#viewMTO">
    ...
    <div class="modal fade" id="viewMTO" tabindex="-1" role="dialog" aria-labelledby="viewMTO" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <script>
        ...
        function view_modal(id) {
            $.ajax({
                type: "GET",
                url: "{!! url('admin/view_product_mto_detail/"+id+"') !!}",
                dataType: "JSON",
                async: false,
