    ...
    <div class="container-fluid px-xxl-65 px-xl-20">
        ...
        <div class="hk-pg-header mb-10">
            <div>
                <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i
                    data-feather="bookmark"></i></span></span>บันทึกป้ายกำกับ (บันทึกโน๊ต)</h4>
            </div>
            <div class="d-flex">
        ...
        <!-- /Title -->
            ...
            <section class="hk-sec-wrapper">
                <h5 class="hk-sec-title">ตารางรายการป้ายกำกับ (บันทึกโน๊ต)</h5>
                <div class="row">
                    <div class="col-sm">
                                    ...
                                    <tr align="center">
                                        ...
                                        <td style="width: 10px;">
                                                    <button onclick="edit_modal({{ $value->id }})"
                                                        class="btn btn-icon btn-warning mr-10" data-toggle="modal" data-target="#editMasterTag">
