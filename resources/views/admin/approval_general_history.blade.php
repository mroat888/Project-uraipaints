        ...
        <div class="row">
            <div class="col-xl-12">
                <section class="hk-sec-wrapper">
                    <div class="row">
                        <div class="col-sm">
                            <a href="{{ url('admin/approvalgeneral') }}" type="button" class="btn btn-secondary btn-wth-icon icon-wthot-bg btn-sm text-white">
                            ...
                            <a href="{{ url('admin/approvalgeneral/history') }}" type="button" class="btn btn-violet btn-wth-icon icon-wthot-bg btn-sm text-white">
                                <span class="icon-label">
...
<div class="modal fade" id="Modalsaleplan" tabindex="-1" role="dialog" >
    @include('admin.general_history_display')
</div>
