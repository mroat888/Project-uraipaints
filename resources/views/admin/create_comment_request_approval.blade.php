        ...
        <div class="row">
            <div class="col-xl-12">
                <section class="hk-sec-wrapper">
                    <div class="row">
                        <div class="col-sm">
                            <form action="{{ url('admin/create_comment_request_approval') }}" method="post" enctype="multipart/form-data">
                                @csrf
                            ...
                            <div class="modal-footer">
                                <a href="{{ url('admin/approval_general_detail', $createID) }}" type="button" class="btn btn-secondary">ย้อนกลับ</a>
