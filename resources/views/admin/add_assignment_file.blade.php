...
@section('content')
 ...
 <nav class="hk-breadcrumb" aria-label="breadcrumb">
    <ol class="breadcrumb breadcrumb-light bg-transparent">
        <li class="breadcrumb-item">สั่งงานผู้จัดการเขต และ ผู้แทนขาย</li>
        <li class="breadcrumb-item active">แกลลอรี่</li>
    </ol>
</nav>
<!-- /Breadcrumb -->
    ...
    $("#from_assignment_delete").on("submit", function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ url('admin/delete_assignment_file') }}',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
        ...
        $("#form_insert_assignment_gallery").on("submit", function (e) {
            ...
            $.ajax({
                type:'POST',
                url: '{{ url("admin/create_assignment_gallery") }}',
                data:formData,
                cache:false,
                contentType: false,
                processData: false,
    ...
    <script>
        ...
        function edit_modal(id) {
            $.ajax({
                type: "GET",
                url: "{!! url('admin/edit_assignment_file/"+id+"') !!}",
                dataType: "JSON",
                async: false,
