    ...
    <div class="container-fluid px-xxl-65 px-xl-20">
        ...
        <div class="hk-pg-header mb-10">
            <div>
                <h4 class="hk-pg-title"><span class="pg-title-icon"><i class="ion ion-md-analytics"></i></span>Sale Plan
                </h4>
            </div>
        </div>
        <!-- /Title -->
                                ...
                                <table id="datable_1" class="table table-hover table-sm w-100 display pb-30"
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><span class="badge badge-soft-warning" style="font-weight: bold; font-size: 12px;">Pending</span></td>
                                        </tr>
                                        <tr>
                                            <td>2</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>11/10/2021</td>
                                            <td>บจก. ชัยรุ่งเรือง เวิร์ลเพ็นท์</td>
                                            <td><span class="badge badge-soft-secondary" style="font-weight: bold; font-size: 12px;">Draft</span></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
