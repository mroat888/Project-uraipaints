        ...
        <div class="row">
            <div class="col-xl-12">
                <section class="hk-sec-wrapper">
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <a href="{{url('head/palncalendar')}}" type="button" class="btn bg-violet btn-wth-icon icon-wthot-bg btn-sm text-white">
                            ...
                            <a href="{{url('head/saleWork')}}" type="button" class="btn btn-secondary btn-wth-icon icon-wthot-bg btn-sm text-white">
                                <span class="icon-label">
