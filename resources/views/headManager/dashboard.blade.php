        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-lg-8">
                <section class="hk-sec-wrapper">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <a href="{{ url('head/approvalgeneral') }}">
                        ...
                        <div class="col-md-6">
                            <a href="{{ url('head/assignment/add') }}">
                            <div class="bg-card-blue card-sm">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-2">
                        ...
                        <div class="col-md-6">
                            <a href="{{ url('head/approval-customer-except') }}">
                            <div class="bg-card-blue card-sm">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-2">
                                ...
                                <div class="card-body" style="color: black;">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="row">
                                                <div class="col-8">
                                                    <a href="{{url('headManage/data_name_store')}}" class="txt-cusall text-dark">ลูกค้าทั้งหมด (ราย)</a>
                                                </div>
                                                <div class="col-4">
                                                    <span class="txt-custotal">
                                                        @if(isset($res_api["data"][0]["Responsibility"]) && $res_api["data"][0]["Responsibility"][0]["ActiveTotal"] > 0)
