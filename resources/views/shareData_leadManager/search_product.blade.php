...
$(document).on('change','.province', function(e){
    ...
    $('#datable_2').DataTable({
        ...
        ajax: {
            method:"GET",
            url:"{{url('fetch_datatable_customer_leaders_pdglist_pvid')}}/"+pdglist+'/'+pvid,
            dataType: 'json',
            data:{
                    "_token": "{{ csrf_token() }}",
                },
    ...
    $.ajax({
        method: 'GET',
        url: '{{ url("/fetch_amphur_products_leaders") }}/'+pdglist+'/'+pvid,
        datatype: 'json',
        success: function(response){
            if(response.status == 200){
...
$(document).on('change','#amphur', function(e){
    ...
    $('#datable_2').DataTable({
        ...
        ajax: {
            method:"GET",
            url:"{{url('fetch_datatable_customer_leaders')}}/"+pdglist+"/"+pvid+"/"+ampid,
            dataType: 'json',
            data:{
                    "_token": "{{ csrf_token() }}",
                },
