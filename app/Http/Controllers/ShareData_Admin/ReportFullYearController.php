...
class ReportFullYearController extends Controller
{
    ...
    public function index()
    {
        ...
        // สินค้า Top Group
        $path_search_top = "reports/years/".$year."/pdgroups?sortorder=DESC"; 
        $api_token = $this->api_token->apiToken();
        ...
        // สินค้า Top SubGroup
        $path_search_top = "reports/years/".$year."/pdsubgroups?sortorder=DESC"; 
        $api_token = $this->api_token->apiToken();
        $response = Http::withToken($api_token)->get(env("API_LINK").env("API_PATH_VER").'/'.$path_search_top);
        ...
        $path_search_top = "reports/years/".$year."/pdlists?sortorder=DESC"; 
        $api_token = $this->api_token->apiToken();
        $response = Http::withToken($api_token)->get(env("API_LINK").env("API_PATH_VER").'/'.$path_search_top);
        ...
        return view('shareData_admin.report_full_year', $data);
    }
    ...
    public function search(Request $request){
        ...
        // สินค้า Top Group
        $path_search_top = "reports/years/".$request->sel_year."/pdgroups?sortorder=DESC"; 
        $api_token = $this->api_token->apiToken();
        $response = Http::withToken($api_token)->get(env("API_LINK").env("API_PATH_VER").'/'.$path_search_top);
        $data['grouptop_api'] = $response->json();
        ...
        // สินค้า Top SubGroup
        $path_search_top = "reports/years/".$request->sel_year."/pdsubgroups?sortorder=DESC"; 
        $api_token = $this->api_token->apiToken();
        $response = Http::withToken($api_token)->get(env("API_LINK").env("API_PATH_VER").'/'.$path_search_top);
        $data['subgrouptop_api'] = $response->json();
        ...
        // สินค้า Top Product List
        $path_search_top = "reports/years/".$request->sel_year."/pdlists?sortorder=DESC"; 
        $api_token = $this->api_token->apiToken();
        $response = Http::withToken($api_token)->get(env("API_LINK").env("API_PATH_VER").'/'.$path_search_top);
        $data['pdlisttop_api'] = $response->json();
