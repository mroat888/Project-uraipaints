...
class ReportFullYearController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('shareData.report_full_year', $data);
    }

    public function search(Request $request){

        $path_search = "reports/years/".$request->sel_year."/sellers/".Auth::user()->api_identify;
        $api_token = $this->api_token->apiToken();
        $response = Http::withToken($api_token)->get(env("API_LINK").env("API_PATH_VER").'/'.$path_search);
        $data['yearseller_api'] = $response->json();
        ...
        $path_search_top = "reports/years/".$request->sel_year."/sellers/".Auth::user()->api_identify."/pdgroups?sortorder=DESC"; 
        $api_token = $this->api_token->apiToken();
        $response = Http::withToken($api_token)->get(env("API_LINK").env("API_PATH_VER").'/'.$path_search_top);
        $data['grouptop_api'] = $response->json();
        ...
        $path_search_top = "reports/years/".$request->sel_year."/sellers/".Auth::user()->api_identify."/pdsubgroups?sortorder=DESC"; 
        $api_token = $this->api_token->apiToken();
        $response = Http::withToken($api_token)->get(env("API_LINK").env("API_PATH_VER").'/'.$path_search_top);
        $data['subgrouptop_api'] = $response->json();
        ...
        $path_search_top = "reports/years/".$request->sel_year."/sellers/".Auth::user()->api_identify."/pdlists?sortorder=DESC"; 
        $api_token = $this->api_token->apiToken();
        $response = Http::withToken($api_token)->get(env("API_LINK").env("API_PATH_VER").'/'.$path_search_top);
        $data['pdlisttop_api'] = $response->json();
