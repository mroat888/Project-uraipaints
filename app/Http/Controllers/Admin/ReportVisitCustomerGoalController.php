...
class ReportVisitCustomerGoalController extends Controller
{
    public function index(){
        ...
        return view('reports.report_visitcustomer_goal_admin', compact('report', 'summary_report', 'report_detail'));
    }
    ...
    public function search(Request $request){
        ...
        return view('reports.report_visitcustomer_goal_admin', $data);
    }
}
