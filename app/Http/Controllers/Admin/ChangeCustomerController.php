...
class ChangeCustomerController extends Controller
{
    ...
    public function index()
    {
        ...
        where `customer_shops`.`shop_status` != ?";
        ...
        $customer_shops = DB::select( $sql_query, [2]);
        ...
        $customer_shops_success = DB::select( $sql_query_success, [2,1]);
        ...
        $customer_shops_result_1 = DB::select( $customer_shops_result_1, [2,2]);
        ...
        $customer_shops_result_2 = DB::select( $customer_shops_result_2, [2,1]);
        ...
        $customer_shops_result_3 = DB::select( $customer_shops_result_3, [2,0]);
