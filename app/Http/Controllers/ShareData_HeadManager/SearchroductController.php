...
class SearchroductController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('shareData_headManager.search_product', compact('pdglists_api'));
    }
    ...
    public function search(Request $request){
        ...
        return view('shareData_headManager.search_product', compact('pdglists_api', 'product_api'));
