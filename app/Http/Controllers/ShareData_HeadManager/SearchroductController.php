...
class SearchroductController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('shareData_headManager.search_product', compact('groups_api', 'pdglists'));
    }
    ...
    public function search(Request $request){
        ...
        return view('shareData_headManager.search_product', compact('groups_api', 'product_api'));
