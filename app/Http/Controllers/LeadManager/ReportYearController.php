    ...
    public function index(){
        ...
        foreach($users as $user){
            ...
            foreach($monthly_plans as $monthly_plans_value){
                ...
                // รายงานลูกค้าเยี่ยม
                if(!is_null($monthly_plans_value->total_cust_visits_amount)){

                    $cust_visits_amount = $monthly_plans_value->total_cust_visits_amount; 
                ...
                // รายงานลูกค้าใหม่
                if(!is_null($monthly_plans_value->total_custnew_amount)){

                    $cust_new_amount = $monthly_plans_value->total_custnew_amount;
                ...
                if(!is_null($monthly_plans_value->total_saleplan_amount)){
                    $sale_plans_amount = $monthly_plans_value->total_custnew_amount;
       ...
       // dd($report_footer);
        return view('reports.report_year', compact('report','report_footer'));
    }
}
