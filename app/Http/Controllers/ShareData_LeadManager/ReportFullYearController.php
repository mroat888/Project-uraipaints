...
class ReportFullYearController extends Controller
{
    ...
    public function index()
    {
        ...
        // สินค้า Top Group
        $path_search_top = "reports/years/".$year."/leaders/".Auth::user()->api_identify."/pdgroups?sortorder=DESC"; 
        $api_token = $this->api_token->apiToken();
        ...
        // สินค้า Top SubGroup
        $path_search_top = "reports/years/".$year."/leaders/".Auth::user()->api_identify."/pdsubgroups?sortorder=DES"; 
        $api_token = $this->api_token->apiToken();
        $response = Http::withToken($api_token)->get(env("API_LINK").env("API_PATH_VER").'/'.$path_search_top);
        ...
        $path_search_top = "reports/years/".$year."/leaders/".Auth::user()->api_identify."/pdlists?sortorder=DESC"; 
        $api_token = $this->api_token->apiToken();
        $response = Http::withToken($api_token)->get(env("API_LINK").env("API_PATH_VER").'/'.$path_search_top);
        ...
        return view('shareData_leadManager.report_full_year', $data);
    }
    ...
    public function search(Request $request){
        ...
        // สินค้า Top Group
        $path_search_top = "reports/years/".$request->sel_year."/leaders/".Auth::user()->api_identify."/pdgroups?sortorder=DESC"; 
        $api_token = $this->api_token->apiToken();
        $response = Http::withToken($api_token)->get(env("API_LINK").env("API_PATH_VER").'/'.$path_search_top);
        $data['grouptop_api'] = $response->json();
        ...
        // สินค้า Top SubGroup
        $path_search_top = "reports/years/".$request->sel_year."/leaders/".Auth::user()->api_identify."/pdsubgroups??sortorder=DESC"; 
        $api_token = $this->api_token->apiToken();
        $response = Http::withToken($api_token)->get(env("API_LINK").env("API_PATH_VER").'/'.$path_search_top);
        $data['subgrouptop_api'] = $response->json();
        ...
        // สินค้า Top Product List
        $path_search_top = "reports/years/".$request->sel_year."/leaders/".Auth::user()->api_identify."/pdlists?sortorder=DESC"; 
        $api_token = $this->api_token->apiToken();
        $response = Http::withToken($api_token)->get(env("API_LINK").env("API_PATH_VER").'/'.$path_search_top);
        $data['pdlisttop_api'] = $response->json();
